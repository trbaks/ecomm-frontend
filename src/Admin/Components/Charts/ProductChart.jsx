...
const ProductChart = ({ products, review, cart, wishlist, paymentData }) => {
    ...
    const productData = [
        {
            name: "Clothes",
            Quantity: products.filter(prod => prod.type === "clothes").length
        },
        {
            name: "Shoes",
    ...
    const cartData = [
        {
            name: "Clothes",
            "Quantity in cart": cart.filter(prod => prod.productId.type === "clothes").length
        },
        {
            name: "Shoes",
    ...
    const wishlistData = [
        {
            name: "Clothes",
            "Quantity in wishlist": wishlist.filter(prod => prod.productId.type === "clothes").length
        },
        {
            name: "Shoes",
        ...
        <>
            <Container sx={{ marginTop: 5,  }}>
                ...
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 15, flexWrap: "wrap" }}>
                    ...
                    <h3 style={{ color: '#0088FE' }}>Clothes</h3>
